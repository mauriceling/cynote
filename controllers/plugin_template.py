def input_form():
    ...
    form = FORM(
            TABLE(
                TR("Sequence: ",
                   TEXTAREA(_name="seq",
                            value="""Enter your sequence in plain text here.
                                    If your sequence is in FASTA format,
                                    just remove the comment line.""")),
               TR("Option",
                  INPUT(_type="checkbox", _name="option")),
               TR("",
...
def multi_input():
    ...
    form = FORM(
            TABLE(
                *[TR('T',
                     INPUT(_type="checkbox", _name='T'))] + \
                 [TR("Option "+str(opt),
                     INPUT(_type="checkbox", _name=str(opt),
